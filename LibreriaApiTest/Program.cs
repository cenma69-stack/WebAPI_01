...
namespace LibreriaApiTest
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //var response = httpClient.GetAsync("api/Genero").Result;
            //var json = response.Content.ReadAsStringAsync().Result;

            //var especies = Newtonsoft.Json.JsonConvert
            //    .DeserializeObject<Modelos.ApiResult<List<Modelos.Genero>>>(json);
